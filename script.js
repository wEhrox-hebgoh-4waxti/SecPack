(function () {
    ...
    /*
     * SecPack — Global Frontend Script
     * --------------------------------
     * This file contains:
     * 1. Language system
     * 2. RTL/LTR direction handling
     * 3. Page title handling
     * 4. Active navigation
     * 5. Button interaction feedback
     * 6. Card animation delays
     * 7. Internal page tracking
     * 8. Section reveal animation
     *
     * Do not duplicate another DOMContentLoaded wrapper
     * around this file.
     */
     ...
     *
     * Re-applies translations when new content
    ...
    function initializeButtons() {
        ...
        buttons.forEach(function (button) {
            ...
            if (
                button.dataset.secpackButtonReady ===
                "true"
            ) {
                return;
            }
    ...
    function initializeLanguageButtons() {
        ...
        languageButtons.forEach(
            function (button) {
                ...
                if (
                    button.dataset.secpackLanguageReady ===
                    "true"
                ) {
                    return;
                }
    ...
    /*
     * Internal page navigation tracking
     */
     ...
     *
     * Language initialization is intentionally
     * performed before visual initialization so
     * that RTL/LTR state is available immediately.
     */
