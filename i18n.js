...
/* SEC PACK i18n core — foundational stable-key architecture.
   D/PAGE_TEXT are retained only as a temporary migration bridge.
   New components MUST use stable data-i18n keys. */
const CORE={
